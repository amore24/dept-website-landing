  ...
  return (
    <>
      ...
      <section className='flex flex-wrap'>
        <div className='relative block-one bg-no-repeat bg-cover bg-center flex-[100%] lg:flex-[50%] h-[540px] '>
        ...
        <div className='relative block-two bg-no-repeat bg-cover bg-center flex-[100%] lg:flex-[50%] h-[540px]'>
          <div className='absolute left-[24px] top-[374px] lg:left-[32px] lg:top-[345px] text-white'>
        ...
        <div className='relative block-three bg-no-repeat bg-cover bg-center flex-[100%] lg:flex-[50%] h-[540px]'>
          <div className='absolute left-[24px] top-[374px] lg:left-[32px] lg:top-[345px] text-white'>
        ...
        <div className='relative block-four bg-no-repeat bg-cover bg-center flex-[100%] lg:flex-[50%] h-[540px]'>
          <div className='absolute left-[32px] top-[345px] text-white'>
