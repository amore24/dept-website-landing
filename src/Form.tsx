        ...
        <section className='flex flex-wrap py-[48px] px-[36px] lg:p-[58px]'>
          ...
          <form action="" className='grid grid-cols-2 flex-[100%] lg:flex-[70%]'>
            <div className='col-span-2 mb-[35px] lg:col-span-1'>
              ...
              <input className='border-b border-gray-300 w-full lg:w-[70%]' type="text" name="name" id="name" required/>
            </div>
            <div className='col-span-2 lg:col-span-1 '>
              <label htmlFor="email">EMAIL</label> <br />
              <input className='border-b border-gray-300 w-full mb-[38px] lg:w-[70%]' type="text" name="email" id="email" required/>
            </div>
            <div className='col-span-2 lg:col-span-2'>
              <label htmlFor="message">MESSAGE</label> <br />
              <textarea className='border-b border-gray-300 w-full lg:w-[35%]' name="message" id="message" required></textarea> <br />
